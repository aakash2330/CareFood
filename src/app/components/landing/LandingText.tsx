...
function LandingText() {
  return (
    <div className="lg:min-w-[400px] xl:min-w-fit  ">

    <div className="flex flex-col">
      <div className="text-[#5F5F5F]  font-semibold text-4xl lg:text-5xl max-w-[300px]  sm:max-w-[400px] md:max-w-[300px] lg:max-w-[500px] xl:min-w-[600px] leading-normal  relative">
      <div className="bg-[#70EA5C38] w-[99px] h-[98px] rounded-full absolute xl:-top-9 xl:left-16"></div>
        <div>
          ORDER WITH PURPOSE{" "}
