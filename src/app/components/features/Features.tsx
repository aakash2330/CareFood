...
function Features() {
  return (
    <div className="bg-[#70EA5C8C] h-[400px] w-full mt-44 flex gap-x-28 px-40 py-20 items-center text-center justify-center">
      <div className="h-[290px] w-[205px] bg-[#FCFCFC] rounded-3xl flex flex-col py-5 px-2">
      ...
      <div className="rounded-full bg-[#FCFCFC] h-20 w-20 text-[#5F5F5F] pt-5 font-semibold text-4xl">1</div>
       <div className="h-[290px] w-[205px] bg-[#FCFCFC] rounded-3xl flex flex-col py-5 px-2">
      ...
      <div className="rounded-full bg-[#FCFCFC] h-20 w-20 text-[#5F5F5F]  pt-5 font-semibold text-4xl">2</div>
       <div className="h-[290px] w-[205px] bg-[#FCFCFC] rounded-3xl flex flex-col py-5 px-2">
